...
import { Lock, Mail, Code2, Loader2, Zap, User } from "lucide-react";
        ...
        <div className="w-full max-w-md space-y-8 relative z-10">
          ...
          <div className="text-center space-y-3">
            ...
            <p className="text-sm text-text-muted">
              Get started with your free cloud developer account
            </p>
          </div>
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative group">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <User className="h-5 w-5 text-text-muted group-focus-within:text-primary transition-colors z-10" />
                  </div>
                  <input
                    type="text"
